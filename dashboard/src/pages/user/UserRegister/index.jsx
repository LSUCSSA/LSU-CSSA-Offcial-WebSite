...
class UserRegister extends Component {
  ...
  checkConfirm = (rule, value, callback) => {
    ...
    if (value && value !== form.getFieldValue('password')) {
      callback(
        formatMessage({
          id: 'useranduserregister.password.twice',
        }),
      );
    } else {
      callback();
  ...
  checkPassword = (rule, value, callback) => {
    ...
    if (!value) {
      this.setState({
        help: formatMessage({
          id: 'useranduserregister.password.required',
        }),
        visible: !!value,
      });
      callback('error');
            ...
            {getFieldDecorator('mail', {
              rules: [
                {
                  ...
                  message: formatMessage({
                    id: 'useranduserregister.email.required',
                  }),
                },
                {
                  type: 'email',
                  message: formatMessage({
                    id: 'useranduserregister.email.wrong-format',
                  }),
                },
              ],
            })(
              <Input
                ...
                placeholder={formatMessage({
                  id: 'useranduserregister.email.placeholder',
                })}
              />,
            )}
          </FormItem>
            ...
            >
              {getFieldDecorator('password', {
                ...
                <Input
                  ...
                  type="password"
                  placeholder={formatMessage({
                    id: 'useranduserregister.password.placeholder',
                  })}
                />,
              )}
            </Popover>
          ...
          <FormItem>
            {getFieldDecorator('confirm', {
              rules: [
                {
                  required: true,
                  message: formatMessage({
                    id: 'useranduserregister.confirm-password.required',
                  }),
                },
                {
              ...
              <Input
                ...
                type="password"
                placeholder={formatMessage({
                  id: 'useranduserregister.confirm-password.placeholder',
                })}
              />,
            )}
          </FormItem>
...
export default connect(({ userAndUserRegister, loading }) => ({
  userAndUserRegister,
