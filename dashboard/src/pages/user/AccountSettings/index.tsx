...
> {
  ...
  constructor(props: AccountSettingsProps) {
    super(props);
    const menuMap = {
      base: <FormattedMessage id="userandaccountsettings.menuMap.basic" defaultMessage="Basic Settings" />,
      security: (
        <FormattedMessage id="userandaccountsettings.menuMap.security" defaultMessage="Security Settings" />
      ),
      binding: (
        <FormattedMessage id="userandaccountsettings.menuMap.binding" defaultMessage="Account Binding" />
      ),
      notification: (
        <FormattedMessage
