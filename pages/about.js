    ...
    <div style={{ textAlign: "center" }}>
      ...
      <Row type="flex" align="top" justify="center" gutter={[32, 8]}>
        <Col xs={24} md={12} style={{ minHeight: 300 }}>
          <Card bordered={false}>
            <CalendarOutlined  style={{ fontSize: 64, padding: 32 }} />
            <Meta
        ...
        <Col xs={24} md={12} style={{ minHeight: 300 }}>
          <Card bordered={false}>
            <CameraOutlined  style={{ fontSize: 64, padding: 32 }} />
            <Meta
        ...
        <Col xs={24} md={12} style={{ minHeight: 300 }}>
          <Card bordered={false}>
            <CodeOutlined  style={{ fontSize: 64, padding: 32 }} />
            <Meta
        ...
        <Col xs={24} md={12} style={{ minHeight: 300 }}>
          <Card bordered={false}>
            <TeamOutlined style={{ fontSize: 64, padding: 32 }} />
            <Meta
